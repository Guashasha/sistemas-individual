...
public class Sistema {
    ...
    public static void main(String[] args) {
        ...
        Generador gen = new Generador(waitQueue, mutWait, ventana);
        Administrador admin = new Administrador(mutWait, waitQueue, mutReady, readyQueue, mutMemory, memoryCurr, MEMORY_MAX, ventana);
        Ejecutador ejec = new Ejecutador(mutReady, readyQueue, mutMemory, memoryCurr, QUANTUM, ventana);
